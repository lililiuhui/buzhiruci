...
public class GuideActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    int resId[] = {R.mipmap.pic1, R.mipmap.pic2,R.mipmap.pic3,R.mipmap.pic4};  //所显示的图片资源数组
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv4 = findViewById(R.id.guide_tv4);
        ...
        guideVp.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                for (int i = 0; i < numList.size(); i++) {
                    numList.get(i).setTextColor(Color.GRAY);
                }
                numList.get(position).setTextColor(Color.WHITE);
